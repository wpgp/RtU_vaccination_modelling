...
filePathData5 <- "Results/DTP3_2/"
load(file=paste0(filePathData5,"simprob_dtp3_2.rda"))
inv.linpred_dtp3_2 <- inv.linpred
...
inv.linpred_dtp3 <- inv.linpred_dtp3_2 * inv.linpred_dtp2 #This "inv.linpred_dtp2" variable value is accessed from the previous line
inv.linpred <- inv.linpred_dtp3
...
writeRaster(rr.mean, paste0(filePathData2, "inla_vax_dtp3_mean_ratio.tif"), overwrite=TRUE)
writeRaster(rr.sd,   paste0(filePathData2, "inla_vax_dtp3_sd_ratio.tif"), overwrite=TRUE)
writeRaster(rr.low,  paste0(filePathData2, "inla_vax_dtp3_low_ratio.tif"), overwrite=TRUE)
writeRaster(rr.up,   paste0(filePathData2, "inla_vax_dtp3_up_ratio.tif"), overwrite=TRUE)
writeRaster(rr.med,  paste0(filePathData2, "inla_vax_dtp3_median_ratio.tif"), overwrite=TRUE)
...
write.csv(dist_out, paste0(filePathData2, "SP_estimates_dtp3.csv"))
...
#The district-level estimates will have the same ordering as in the shapefile if they have the same no of areas
write.csv(dist_out, paste0(filePathData2, "Prefecture_estimates_dtp3.csv"))
...
#The district-level estimates will have the same ordering as in the shapefile if they have the same no of areas
write.csv(dist_out, paste0(filePathData2, "Region_estimates_dtp3.csv"))
...
writeRaster(rr.80, paste0(filePathData2, "inla_vax_dtp3_80perc_thresh.tif"), overwrite=TRUE)
